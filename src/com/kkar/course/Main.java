...
public class Main {
	...
	public static void main(String[] args) {
	 ...
	 Long courseId1 = obj.saveCourse("Physics1");
		...
		/*
		 * Long courseId2 = obj.saveCourse("Chemistry1"); Long courseId3 =
		 * obj.saveCourse("Maths1"); obj.listCourse(); obj.updateCourse(courseId3,
		 * "Mathematics2"); obj.deleteCourse(courseId2); 
		 */ 
